                                ...
                                <TableBody>
                                    {cartItems.map((item) => (
                                        <TableRow key={item._id}>
                                            ...
                                            <TableCell>
                                                <NextLink href={`/product/${item.slug}`} passHref>
                                                    <Link><Typography component="h2" variant="h2">{item.name}</Typography></Link>
                                                </NextLink>
                                            </TableCell>
                            ...
                            <List>
                                <ListItem>
                                    <Typography variant="h2">
                                        Subtototal{' '} ({cartItems.reduce((a,c) => a + c.quantity, 0)}{' '} items)
                                        : Rs.{cartItems.reduce((a,c) => a +c.quantity * c.price, 0)}/-
                                    </Typography>
                                </ListItem>
                                <ListItem>
                                    <Button onClick={checkoutHandler} variant="contained" color="primary">Check Out</Button>
                                </ListItem>
                            </List>
                        </Card>
                    </Grid>
