      ...
      <Grid container spacing={1}>
        ...
        <Grid item md={3} xs={6}>
          <List>
            ...
            <ListItem>
              <NextLink
                href={`/product/packing/${product.slug}?servings=${servings}`}
                passHref
              >
                <Link>
            ...
            <ListItem>
              <NextLink
                href={`/product/cooking/${product.slug}?servings=${servings}`}
                passHref
              >
                <Link>
                  <Typography component="h2" variant="h2">
        ...
        <Grid item md={3} xs={12}>
          <Card>
            <List>
              ...
              <ListItem>
                <Typography>Minimum Servings to order is 2 </Typography>
              </ListItem>
              <ListItem>
                <Grid container>
                  <Grid item xs={6}>
